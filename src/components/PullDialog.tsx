...
export function PullDialog({
  ...
  return (
    <div className="fixed inset-0 bg-theme-overlay flex items-center justify-center z-50">
      <div className="bg-theme-surface border border-theme-default rounded-lg w-[480px] shadow-2xl">
        {/* Header */}
        ...
        <div className="px-6 py-4 space-y-4">
          ...
          {behind === 0 && (
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-theme-secondary">Already up to date</span>
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              {/* Merge Option */}
              <label className="flex items-start gap-3 p-3 rounded-lg border border-theme-default hover:border-theme-default cursor-pointer transition-colors">
                <input
                  type="radio"
                  name="strategy"
                  value="merge"
                ...
                <div className="flex-1">
                  <div className="font-medium text-theme-primary">Merge (default)</div>
              ...
              <label className="flex items-start gap-3 p-3 rounded-lg border border-theme-default hover:border-theme-default cursor-pointer transition-colors">
                ...
                />
                <div className="flex-1">
                  <div className="font-medium text-theme-primary">Rebase</div>
                  <div className="text-xs text-theme-tertiary mt-0.5">
