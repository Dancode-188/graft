...
export function StashCreateModal({ repoPath, onClose, onSuccess }: StashCreateModalProps) {
  ...
  return (
    <div 
      className="fixed inset-0 bg-theme-overlay backdrop-blur-sm flex items-center justify-center z-50"
      onClick={onClose}
    >
      <div 
        className="bg-theme-surface border border-theme-default rounded-lg shadow-2xl w-full max-w-md"
        onClick={(e) => e.stopPropagation()}
        onKeyDown={handleKeyDown}
      >
        {/* Header */}
        <div className="border-b border-theme-default p-4">
          <h2 className="text-lg font-semibold text-theme-primary">Create Stash</h2>
        ...
        <div className="p-4 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-theme-bg border border-theme-default rounded text-sm text-theme-primary placeholder-theme-tertiary focus:outline-none focus:ring-2 focus:ring-graft-500"
              autoFocus
            />
            <p className="text-xs text-theme-tertiary mt-1">
          ...
          <div className="space-y-3">
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                className="mt-0.5 w-4 h-4 bg-theme-bg border-theme-default rounded text-graft-500 focus:ring-2 focus:ring-graft-500"
              />
              <div>
                <div className="text-sm text-theme-secondary">Include untracked files</div>
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              />
              <div>
                <div className="text-sm text-theme-secondary">Keep staged changes</div>
                <div className="text-xs text-theme-tertiary">
        ...
        {/* Footer */}
        <div className="border-t border-theme-default p-4 flex items-center justify-between">
          <div className="text-xs text-theme-tertiary">
